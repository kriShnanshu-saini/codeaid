			...
			<div className='flex flex-row items-center gap-3'>
				...
				<div className='flex flex-col overflow-hidden'>
					<figcaption className='flex flex-row items-center whitespace-pre text-lg font-medium dark:text-white'>
						...
						<span className='text-xs text-gray-500'>{convertDateToRelativeTime(new Date(user.$updatedAt))}</span>
					</figcaption>
...
export default async function TopContributors() {
	...
	return (
		<div className='flex-col basis-1/2 space-y-6'>
			<h2 className='text-lg inline-block'>Top Contributors</h2>
			<div className='bg-background relative flex h-[400px] w-full max-w-[32rem] flex-col overflow-hidden rounded-lg p-6 shadow-lg dark:bg-white/5 '>
				<AnimatedList>

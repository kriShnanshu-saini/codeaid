    ...
    return (
        <TracingBeam className="container pl-6">
            <Particles
                ...
                refresh
            />
            <div className="relative mx-auto px-4 pb-20 pt-36 dark:text-white">
                <div className="flex">
                    <div className="w-full">
                        <h1 className="mb-1 text-3xl font-bold text-orange-500">{question.title}</h1>
                ...
                <div className="flex gap-4">
                    ...
                    <div className="w-full overflow-auto">
                        ...
                        <div className="mt-4 flex items-center justify-end gap-1">
                            <picture>
                                <img
                                    src={avatars.getInitials(author.name, 24, 24).href}
                                    alt={author.name}

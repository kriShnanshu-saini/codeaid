...
export const metadata: Metadata = {
	title: 'Questions | CodeAid',
	description: 'Questions posted by the developers',
};
...
const Page = async ({
    ...
    return (
        <div className="container mx-auto px-4 pb-20 pt-36 dark:text-white">
            <div className="mb-10 flex items-center justify-between">
                <h1 className="text-3xl font-bold">All Questions</h1>
                <Link href="/questions/ask">
                    <ShimmerButton className="shadow-2xl dark:border dark:border-white/30">

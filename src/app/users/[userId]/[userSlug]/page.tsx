...
const Page = async ({ params }: { params: { userId: string; userSlug: string } }) => {
	...
	return (
		// prettier-ignore
		<MagicContainer className={'flex h-[500px] w-full flex-col gap-4 lg:h-[250px] lg:flex-row mt-2'}>
			<MagicCard className='flex w-full cursor-pointer flex-col items-center justify-center overflow-hidden p-20 shadow-2xl'>
                ...
                <p className='z-10 whitespace-nowrap text-4xl font-medium text-gray-800 dark:text-gray-200'>{user.prefs.reputation === 0 ? '0' : (
